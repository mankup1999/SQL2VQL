...
@CustomElement(type = CustomElementType.VDPAGGREGATEFUNCTION, name = "PERCENTILE_DISC_AGG_ORACLE")
public class Percentile_Disc {
    @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                ...
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
	 ...
	 @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                databaseVersions = { "10g", "11g" },
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1 DESC))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
			@CustomParam(name = "arg1") double arg1,
            @CustomGroup(name = "arg2", groupType = Double.class)
            CustomGroupValue<Double>... textField){
	 ...
	 @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                databaseVersions = { "10g", "11g" },
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1 ASC))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
			@CustomParam(name = "arg1") double arg1,
            @CustomGroup(name = "arg2", groupType = Double.class)
            CustomGroupValue<Double>... textField){
	 ...
	 @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                databaseVersions = { "10g", "11g" },
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1) OVER (PARTITION BY $2))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
			@CustomParam(name = "arg1") double arg1,
            @CustomGroup(name = "arg2", groupType = Double.class)
            CustomGroupValue<Double>... textField),
	 ...
	 @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                databaseVersions = { "10g", "11g" },
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1 DESC) OVER (PARTITION BY $2))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
			@CustomParam(name = "arg1") double arg1,
            @CustomGroup(name = "arg2", groupType = Double.class)
            CustomGroupValue<Double>... textField),
	 ...
	 @CustomExecutor(implementation = true, delegationPatterns = {
            @DelegationPattern(databaseName = "oracle",
                                databaseVersions = { "10g", "11g" },
                                pattern = "PERCENTILE_DISC($0) WITHIN GROUP (ORDER BY $1 ASC) OVER (PARTITION BY $2))") })
     public Double... PERCENTILE_DISC_AGG_ORACLE (
			@CustomParam(name = "arg1") double arg1,
            @CustomGroup(name = "arg2", groupType = Double.class)
            CustomGroupValue<Double>... textField),
